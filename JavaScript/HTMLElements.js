...
function ReturnElementString(element){
    ...
    else if(element==="noframes"){
        return "noframes>";
    }
    else if(element==="noscript"){
        return "noscript>";
    }
